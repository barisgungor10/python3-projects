...
pet = input("What is your cat's name?: ")
#4. Combining the name of their city and pet and show them their band name.
brand_name = city + " " + pet
#5. Making sure the input cursor shows on a new line:
